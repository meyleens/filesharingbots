...
<p align="center"><a href="https://heroku.com/deploy?template=https://github.com/meyleens/filesharingbots">
  <img src="https://img.shields.io/badge/Deploy%20To%20Heroku-aqua?style=flat&logo=heroku" width="325" height="50.100" /></a></p>


#### Deploy in your VPS
````bash
git clone https://github.com/meyleens/filesharingbots
cd File-Sharing-Man
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/meyleens/filesharingbots/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/meyleens/filesharingbots/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
